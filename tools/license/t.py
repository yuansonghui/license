...
def register_2_7_6(sn,machineid,active_time,capacity):
    args = '/root/license_2.7.6 -k {0} {1} {2} {3}'.format(sn, machineid, active_time,capacity)
    code, out = commands.getstatusoutput(args)
    re.findall(c,out)[0]
    return out

def register_2_7_5(sn,machineid,active_time,capacity):
    args = '/root/license_2.7.5_i -k {0} {1} {2} {3}'.format(sn, machineid, active_time,capacity)
    code, out = commands.getstatusoutput(args)
    re.findall(c,out)[0]
    return out

def register_2.7.3(sn,machineid,active_time,capacity):
    args = '/root/license_2.7 -k {0} {1} {2}'.format(machineid, active_time,capacity)
    code, out = commands.getstatusoutput(args)
    re.findall(c,out)[0]
    return out

sandstone_version = {'2.9.1': register_2_9_1,'2.7.6': register_2_7_6,'2.7.5': register_2_7_6, '2.7.3': register_2_7_3}
